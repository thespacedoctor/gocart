...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.colors',
                'matplotlib.pyplot', 'matplotlib.cm', 'matplotlib.path', 'matplotlib.patches', 'matplotlib.projections', 'matplotlib.projections.geo', 'healpy', 'astropy', 'astropy.io', 'pylibmc', 'HMpTy', 'HMpTy.mysql', 'ligo.skymap', 'ligo', 'ligo.gracedb', 'ligo.gracedb.rest', 'pandas', 'astropy-healpix']
...
html_theme_options = {
    ...
    'github_repo': 'gocart',
    'strap_line': "Listen for, collect and convert multimessenger skymaps"
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/gocart/tree/master"
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/gocart.rst']
modindex_common_prefix = ["gocart."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'gocart.tex', u'gocart Documentation',
     u'Dave Young', 'manual'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["gocart"]
    allSubpackages += findAllSubpackges(
        pathToPackage="gocart"
    )
